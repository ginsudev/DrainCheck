...
static NSString *bundleID = @"com.ginsu.draincheckactivatorListener-toggle";
static LAActivator *_LASharedActivator;

@interface draincheckactivatorListenerToggle : NSObject <LAListener>

+ (id)sharedInstance;

@end

@implementation draincheckactivatorListenerToggle
...
- (void)activator:(LAActivator *)activator receiveEvent:(LAEvent *)event forListenerName:(NSString *)listenerName {
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:@"DrainCheck.isEnabled"]) {
...
- (NSString *)activator:(LAActivator *)activator requiresLocalizedTitleForListenerName:(NSString *)listenerName {
	return @"Toggle DrainCheck on/off";
}
// Listener description
- (NSString *)activator:(LAActivator *)activator requiresLocalizedDescriptionForListenerName:(NSString *)listenerName {
	return @"Toggles DrainCheck on/off";
}
// Group name
